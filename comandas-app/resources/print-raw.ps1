# Manda un fichero de bytes (ESC/POS) directamente a la cola de Windows como
# trabajo RAW, sin pasar por GDI ni por el renderizado de página de Electron.
# Es la misma técnica que usan la mayoría de programas de TPV para imprimir en
# impresoras de tickets ya instaladas como impresora de Windows, y evita por
# completo los problemas de tamaño de página / pintado en blanco que da
# webContents.print({silent:true}) con algunos drivers.
param(
