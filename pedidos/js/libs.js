...
/* ═══════════════════════════════════════════════════
   Librerías externas: Firebase App + Database + EmailJS
   ═══════════════════════════════════════════════════ */
...
!function (e, t) {
  ...
  class d {
    ...
    create(e) {
      var n,
        ...
        a = "".concat(this.service, "/").concat(e),
        i = this.errors[e],
        i = i ? (n = r, i.replace(p, (e, t) => {
          var r = n[t];
          return null != r ? String(r) : "<".concat(t, "?>");
        })) : "Error",
        i = "".concat(this.serviceName, ": ").concat(i, " (").concat(a, ").");
      return new o(a, i, r);
    }
  }
  const p = /\{\$([^}]+)}/g;
  ...
  class y {
    ...
    clearInstance() {
      let e = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : E;
    ...
    getOrInitializeService(_ref6) {
      let e = _ref6.instanceIdentifier,
        _ref6$options = _ref6.options,
        t = _ref6$options === void 0 ? {} : _ref6$options;
    ...
    N = function (e, t) {
      if (!(t < e.logLevel)) {
        var n = new Date().toISOString(),
          a = L[t];
        if (!a) throw new Error("Attempted to log a message with an invalid logType (value: ".concat(t, ")"));
        for (var _len = arguments.length, r = new Array(_len > 2 ? _len - 2 : 0), _key = 2; _key < _len; _key++) {
          r[_key - 2] = arguments[_key];
        }
        console[a]("[".concat(n, "]  ").concat(e.name, ":"), ...r);
      }
    };
  class B {
    constructor(e) {
  ...
  function V(n) {
    return n !== IDBDatabase.prototype.transaction || "objectStoreNames" in IDBTransaction.prototype ? (M = M || [IDBCursor.prototype.advance, IDBCursor.prototype.continue, IDBCursor.prototype.continuePrimaryKey]).includes(n) ? function () {
  ...
  function K(e, t) {
    if (e instanceof IDBDatabase && !(t in e) && "string" == typeof t) {
      ...
      if (a in (i ? IDBIndex : IDBObjectStore).prototype && (s || W.includes(a))) {
        var r = async function (e) {
          var r = this.transaction(e, s ? "readwrite" : "readonly");
          let n = r.store;
          for (var _len0 = arguments.length, t = new Array(_len0 > 1 ? _len0 - 1 : 0), _key0 = 1; _key0 < _len0; _key0++) {
            t[_key0 - 1] = arguments[_key0];
          }
  ...
  function ne(t, r) {
    try {
      ...
      q.debug("Component ".concat(r.name, " failed to register with FirebaseApp ").concat(t.name), e);
    }
  }
  function ae(e, t) {
  ...
  function ie(e) {
    var t = e.name;
    if (re.has(t)) return q.debug("There were multiple attempts to register component ".concat(t, ".")), !1;
    re.set(t, e);
  ...
  function pe(e, t, r) {
    ...
    var a = n.match(/\s|\//),
      i = t.match(/\s|\//);
    if (a || i) {
      const s = ["Unable to register library \"".concat(n, "\" with version \"").concat(t, "\":")];
      return a && s.push("library name \"".concat(n, "\" contains illegal characters (whitespace or \"/\")")), a && i && s.push("and"), i && s.push("version name \"".concat(t, "\" contains illegal characters (whitespace or \"/\")")), void q.warn(s.join(" "));
    }
    ie(new _("".concat(n, "-version"), () => ({
      library: n,
      version: t
    }), "VERSION"));
  }
  function ue(e, t) {
    ...
    !function (i, e) {
      for (const t of I) {
        let a = null;
        e && e.level && (a = O[e.level]), t.userLogHandler = null === i ? null : function (e, t) {
          for (var _len1 = arguments.length, r = new Array(_len1 > 2 ? _len1 - 2 : 0), _key1 = 2; _key1 < _len1; _key1++) {
            r[_key1 - 2] = arguments[_key1];
          }
          var n = r.map(e => {
  ...
  let ve = null;
  function _e() {
    return ve = ve || function (e, t, _ref7) {
      let r = _ref7.blocked,
        n = _ref7.upgrade,
        a = _ref7.blocking,
        i = _ref7.terminated;
  ...
  class we {
    ...
    async getHeartbeatsHeader() {
      ...
      var e = Ie(),
        _ref8 = function (e) {
          let t = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 1024;
          const r = [];
          let n = e.slice();
          for (const a of e) {
        ...
        t = _ref8.heartbeatsToSend,
        r = _ref8.unsentEntries,
        t = a(JSON.stringify({
          version: 2,
          heartbeats: t
        }));
  ...
  var Se = Object.freeze({
    ...
    _removeServiceInstance: function (e, t) {
      let r = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : Q;
      se(e, t).clearInstance(r);
    },
    deleteApp: de,
    getApp: function () {
      let e = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : Q;
      var t = te.get(e);
  ...
  class Oe {
    ...
    _getService(e) {
      let t = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : Q;
      var r;
    ...
    !function () {
      ...
      class T {
        ...
        compress_(n, r) {
          r = r || 0;
          const i = this.W_;
          if ("string" == typeof n) for (let e = 0; e < 16; e++) i[e] = n.charCodeAt(r) << 24 | n.charCodeAt(r + 1) << 16 | n.charCodeAt(r + 2) << 8 | n.charCodeAt(r + 3), r += 4;else for (let t = 0; t < 16; t++) i[t] = n[r] << 24 | n[r + 1] << 16 | n[r + 2] << 8 | n[r + 3], r += 4;
          for (let d = 16; d < 80; d++) {
        ...
        update(n, r) {
          if (null != n) {
            ...
            let t = this.inbuf_;
            for (; e < r;) {
              if (0 === t) for (; e <= i;) this.compress_(n, e), e += this.blockSize;
              if ("string" == typeof n) {
                for (; e < r;) if (s[t] = n.charCodeAt(e), ++t, ++e, t === this.blockSize) {
                  this.compress_(s), t = 0;
                  break;
                }
              } else for (; e < r;) if (s[t] = n[e], ++t, ++e, t === this.blockSize) {
                this.compress_(s), t = 0;
                break;
              }
            }
        ...
        digest() {
          ...
          let n = 0;
          for (let i = 0; i < 5; i++) for (let e = 24; 0 <= e; e -= 8) t[n] = this.chain_[i] >> e & 255, ++n;
          return t;
        }
      }
      function E(e, t, n, r) {
      ...
      class A {
        ...
        setComponent(e) {
          ...
          if (this.component = e, this.shouldAutoInitialize()) {
            ...
            for (var _ref9 of this.instancesDeferred.entries()) {
        ...
        clearInstance() {
          let e = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : D;
          this.instancesDeferred.delete(e), this.instancesOptions.delete(e), this.instances.delete(e);
        }
        async delete() {
          const e = Array.from(this.instances.values());
        ...
        initialize() {
          ...
          var _e$options2 = e.options,
            t = _e$options2 === void 0 ? {} : _e$options2,
          ...
          for (var _ref1 of this.instancesDeferred.entries()) {
            var _ref10 = _ref1;
        ...
        getOrInitializeService(_ref12) {
          let e = _ref12.instanceIdentifier,
            _ref12$options = _ref12.options,
            t = _ref12$options === void 0 ? {} : _ref12$options;
        ...
        q = function (e, t) {
          if (!(t < e.logLevel)) {
            var r = new Date().toISOString(),
              i = F[t];
            if (!i) throw new Error("Attempted to log a message with an invalid logType (value: ".concat(t, ")"));
            for (var _len11 = arguments.length, n = new Array(_len11 > 2 ? _len11 - 2 : 0), _key11 = 2; _key11 < _len11; _key11++) {
              n[_key11 - 2] = arguments[_key11];
            }
            console[i]("[".concat(r, "]  ").concat(e.name, ":"), ...n);
          }
        };
      class W {
        constructor(e) {
        ...
        set logLevel(e) {
          if (!(e in n)) throw new TypeError("Invalid value \"".concat(e, "\" assigned to `logLevel`"));
          this._logLevel = e;
        }
        setLogLevel(e) {
      ...
      function le() {
        var t = "FIREBASE INTERNAL ERROR: " + ie(...arguments);
        ne.error(t);
      }
      function he(e, t) {
      ...
      const _e = function (e, t) {
        ...
        fe = function () {
          var t = "FIREBASE FATAL ERROR: ".concat(ie(...arguments));
          throw ne.error(t), new Error(t);
        },
        ge = function () {
          var t = "FIREBASE WARNING: " + ie(...arguments);
          ne.warn(t);
        },
        me = function () {
      ...
      class Re {
        ...
        notifyForInvalidToken() {
          ge("Provided AppCheck credentials for the app named \"".concat(this.appName_, "\" ") + "are invalid. This usually indicates your app was not initialized correctly.");
        }
      }
      class xe {
        constructor(e, t, n) {
      ...
      function Fe(e, t, n) {
        ...
        let r;
        if (t === Oe) r = (e.secure ? "wss://" : "ws://") + e.internalHost + "/.ws?";else {
      ...
      class Ve {
        ...
        open(e, t) {
          ...
          this.curSegmentNum = 0, this.onDisconnect_ = t, this.myPacketOrderer = new je(e), this.isClosed_ = !1, this.connectTimeoutTimer_ = setTimeout(() => {
            ...
            if (!this.isClosed_) {
              this.scriptTagHolder = new ze(function () {
                ...
                var t = e[0],
                  n = e[1],
                  r = e[2];
                if (_this.incrementIncomingBytes_(e), _this.scriptTagHolder) if (_this.connectTimeoutTimer_ && (clearTimeout(_this.connectTimeoutTimer_), _this.connectTimeoutTimer_ = null), _this.everConnected_ = !0, "start" === t) _this.id = n, _this.password = r;else {
                  if ("close" !== t) throw new Error("Unrecognized command received: " + t);
                  n ? (_this.scriptTagHolder.sendNewPolls = !1, _this.myPacketOrderer.closeAfter(n, () => {
                    _this.onClosed_();
                  })) : _this.onClosed_();
                }
              }, function () {
                ...
                var t = e[0],
                  n = e[1];
                _this.incrementIncomingBytes_(e), _this.myPacketOrderer.handleResponse(t, n);
              }, () => {
                this.onClosed_();
              }, this.urlFn);
              const t = {
      ...
      class Ye {
        ...
        initTransports_(e) {
          ...
          if (e.webSocketOnly && (t || ge("wss:// URL used, but browser isn't known to support websockets.  Trying anyway."), n = !0), n) this.transports_ = [Qe];else {
      ...
      class Ge {
        ...
        trigger(t) {
          if (Array.isArray(this.listeners_[t])) {
            ...
            for (var _len21 = arguments.length, n = new Array(_len21 > 1 ? _len21 - 1 : 0), _key21 = 1; _key21 < _len21; _key21++) {
              n[_key21 - 1] = arguments[_key21];
            }
        ...
        off(e, t, n) {
          ...
          for (let i = 0; i < r.length; i++) if (r[i].callback === t && (!n || n === r[i].context)) return void r.splice(i, 1);
        }
      ...
      function ot(e, t) {
        ...
        if (t instanceof Xe) for (let e = t.pieceNum_; e < t.pieces_.length; e++) n.push(t.pieces_[e]);else {
          var r = t.split("/");
      ...
      class gt extends $e {
        ...
        static warnOnListenWarnings_(e, t) {
          if (e && "object" == typeof e && w(e, "w")) {
            const i = C(e, "w");
            var n, r;
            Array.isArray(i) && ~i.indexOf("no_index") && (n = '".indexOn": "' + t._queryParams.getIndex().toString() + '"', r = t._path.toString(), ge("Using an unspecified index. Your data will be downloaded and " + "filtered on the client. Consider adding ".concat(n, " at ") + "".concat(r, " to your security rules for better performance.")));
          }
        }
        refreshAuthToken(e) {
        ...
        async establishConnection_() {
          if (this.shouldReconnect_()) {
            ...
            try {
              var _await$Promise$all = await Promise.all([this.authTokenProvider_.getToken(a), this.appCheckTokenProvider_.getToken(a)]),
                _await$Promise$all2 = _slicedToArray(_await$Promise$all, 2),
                l = _await$Promise$all2[0],
                h = _await$Promise$all2[1];
      ...
      class bt {
        constructor(e, t, n, r) {
          ...
          let s = 1;
          for (; !e.isEmpty();) if (s = t ? n(e.key, t) : 1, r && (s *= -1), s < 0) e = this.isReverse_ ? e.left : e.right;else {
            if (0 === s) {
      ...
      class Tt {
        constructor(e) {
          let t = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : Tt.EMPTY_NODE;
      ...
      class xt {
        constructor(e) {
          let t = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : xt.__childrenNodeConstructor.EMPTY_NODE;
      ...
      class tn {
        ...
        updateFullNode(e, n, t) {
          let r;
          if (n.isLeafNode() || n.isEmpty()) r = jt.EMPTY_NODE.withIndex(this.index_);else if (2 * this.limit_ < n.numChildren() && n.isIndexed(this.index_)) {
      ...
      class hn extends $e {
        ...
        restRequest_(i) {
          ...
          return s.format = "export", Promise.all([this.authTokenProvider_.getToken(!1), this.appCheckTokenProvider_.getToken(!1)]).then(_ref13 => {
            ...
            const n = (this.repoInfo_.secure ? "https://" : "http://") + this.repoInfo_.host + i + "?ns=" + this.repoInfo_.namespace + function (e) {
              const t = [];
              for (const _ref15 of Object.entries(e)) {
      ...
      class An {
        constructor(e) {
          let t = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : (Dn = Dn || new Tt(he), Dn);
          ...
          l.visible && (a >= r && function (e, t) {
            {
              ...
              for (const n in e.children) if (e.children.hasOwnProperty(n) && ut(ot(e.path, n), t)) return !0;
              return !1;
            }
      ...
      function Yn(e, t, n) {
        ...
        for (let s = 0; s < e.length; ++s) {
          ...
          if (t(o)) {
            var i = o.path;
            let e;
            if (o.snap) ut(n, i) ? (e = lt(n, i), r = Ln(r, e, o.snap)) : ut(i, n) && (e = lt(i, n), r = Ln(r, Ze(), o.snap.getChild(e)));else {
              if (!o.children) throw c("WriteRecord should have .snap or .children");
              if (ut(n, i)) e = lt(n, i), r = Mn(r, e, o.children);else if (ut(i, n)) if (e = lt(i, n), at(e)) r = Mn(r, Ze(), o.children);else {
      ...
      class rr {
        ...
        trackChildChange(e) {
          ...
          if (r) {
            var i = r.type;
            if ("child_added" === t && "child_removed" === i) this.changeMap.set(n, Xt(n, e.snapshotNode, r.snapshotNode));else if ("child_removed" === t && "child_added" === i) this.changeMap.delete(n);else if ("child_removed" === t && "child_changed" === i) this.changeMap.set(n, Jt(n, r.oldSnap));else if ("child_changed" === t && "child_added" === i) this.changeMap.set(n, Gt(n, e.snapshotNode));else {
      ...
      function lr(e, t, n, r, i, s, o, a) {
        ...
        if (at(n)) h = c.updateFullNode(l.getNode(), r, null);else if (c.filtersNodes() && !l.isFiltered()) {
      ...
      function hr(t, n, r, i, e, s, o) {
        ...
        if (at(r)) h = t.filter.updateFullNode(n.eventCache.getNode(), i, o), l = Nn(n, h, !0, t.filter.filtersNodes());else {
          var u = et(r);
          if (".priority" === u) h = t.filter.updatePriority(n.eventCache.getNode(), i), l = Nn(n, h, a.isFullyInitialized(), a.isFiltered());else {
            var d = nt(r);
      ...
      function br(e, t, n, r, i, s) {
        var o = Cr(e, t, r, i, s);
        return e.views.has(t._queryIdentifier) || e.views.set(t._queryIdentifier, o), o.eventRegistrations_.push(n), function (e, t) {
      ...
      function Ir(e, t, n, r) {
        ...
        let o = [];
        var a = Nr(e);
        if ("default" === i) for (var _ref17 of e.views.entries()) {
          var _ref18 = _slicedToArray(_ref17, 2);
          var l = _ref18[0];
          var h = _ref18[1];
          o = o.concat(fr(h, n, r)), pr(h) && (e.views.delete(l), h.query._queryParams.loadsAllData() || s.push(h.query));
        } else {
      ...
      function Wr(e, t, n) {
        ...
        return c || o || r || (c = Sr(a, t), d = d.concat(function (t, e, n) {
          ...
          if (i) p(!Nr(a.value), "If we're adding a query, it shouldn't be shadowed");else {
            var l = a.fold((e, t, r) => {
        ...
        if (!n || void 0 !== t) {
          ...
          be(t, (e, t) => {
            ...
            for (r = 0; r < n.length; r++) {
              i = n[r];
              var s = it(i);
              for (let e = 0; e < s.length; e++) if ((".priority" !== s[e] || e !== s.length - 1) && !Ii(s[e])) throw new Error(t + "contains an invalid key (" + s[e] + ") in path " + i.toString() + '. Keys must be non-empty strings and can\'t contain ".", "#", "$", "/", "[", or "]"');
            }
            n.sort(ht);
            let e = null;
            for (r = 0; r < n.length; r++) {
        ...
        ki = function (o, e, t) {
          ...
          if (e && "object" == typeof e) {
            let i = !1,
              s = !1;
            if (be(e, (e, t) => {
              if (".value" === e) i = !0;else if (".priority" !== e && ".sv" !== e && (s = !0, !Ii(e))) throw new Error(o + " contains an invalid key (" + e + ") " + pt(a) + '.  Keys must be non-empty strings and can\'t contain ".", "#", "$", "/", "[", or "]"');
              var n, r;
      ...
      function qi(o, e, t) {
        if (o.stats_ = Be(o.repoInfo_), o.forceRestClient_ || function () {
          ...
          Bi(o, e, t, n, r);
        }, o.authTokenProvider_, o.appCheckProvider_), setTimeout(() => ji(o, !0), 0);else {
          if (null != t) {
      ...
      function Zi(t) {
        let e = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : t.transactionQueueTree_;
        if (e || rs(t, e), li(e)) {
          const n = ns(t, e);
          p(0 < n.length, "Sending zero length transaction queue"), n.every(e => 0 === e.status) && function (i, s, o) {
            ...
            i.server_.put(h.toString(), l, t => {
              ...
              if ("ok" === t) {
                ...
                if ("datastale" === t) for (let e = 0; e < o.length; e++) 3 === o[e].status ? o[e].status = 4 : o[e].status = 0;else {
        ...
        return function (i, s, o) {
          if (0 !== s.length) {
            ...
            for (let r = 0; r < s.length; r++) {
              ...
              let e = !1,
                t;
              if (p(null !== a, "rerunTransactionsUnderNode_: relativePath should not be null."), 4 === u.status) e = !0, t = u.abortReason, n = n.concat(Lr(i.serverSyncTree_, u.currentWriteId, !0));else if (0 === u.status) if (u.retryCount >= Mi) e = !0, t = "maxretry", n = n.concat(Lr(i.serverSyncTree_, u.currentWriteId, !0));else {
      ...
      const os = function (e, t) {
        ...
        as = function (r) {
          ...
          if ("string" == typeof r) {
            ...
            -1 === t && (t = r.length);
            let n = r.indexOf("?");
            -1 === n && (n = r.length), i = r.substring(0, Math.min(t, n)), t < n && (a = function (e) {
              let t = "";
              var n = e.split("/");
              for (let r = 0; r < n.length; r++) if (0 < n[r].length) {
                let e = n[r];
                try {
            ...
            var d,
              _ = function (e) {
                ...
                for (const r of (e = "?" === e.charAt(0) ? e.substring(1) : e).split("&")) {
                  var n;
                  0 !== r.length && (2 === (n = r.split("=")).length ? t[decodeURIComponent(n[0])] = decodeURIComponent(n[1]) : ge("Invalid query segment '".concat(r, "' in query '").concat(e, "'")));
                }
                return t;
        ...
        hs = function () {
          ...
          return function (e) {
            ...
            if (t) {
              ...
              o[n]++;
            } else for (n = 0; n < 12; n++) o[n] = Math.floor(64 * Math.random());
      ...
      function Ts(e, t) {
        ...
        return function (i, s, e, o) {
          ...
          }), n) pe("update() called with empty data.  Don't do anything."), Ji(0, o, "ok", void 0);else {
            const l = zi(i);
      ...
      function Ys(e) {
        let n = R(e);
        for (var _len23 = arguments.length, t = new Array(_len23 > 1 ? _len23 - 1 : 0), _key23 = 1; _key23 < _len23; _key23++) {
          t[_key23 - 1] = arguments[_key23];
        }
      ...
      function Js(e, t, n, r, i) {
        ...
        void 0 === s && (e.options.projectId || fe("Can't determine Firebase Database URL. Be sure to include  a Project ID when calling firebase.initializeApp()."), pe("Using default host for project ", e.options.projectId), s = "".concat(e.options.projectId, "-default-rtdb.firebaseio.com"));
        let o = os(s, i),
          a = o.repoInfo,
          l,
          h = void 0;
        "undefined" != typeof process && process.env && (h = process.env[Ks]), h ? (l = !0, s = "http://".concat(h, "?ns=").concat(a.namespace), o = os(s, i), a = o.repoInfo) : l = !o.repoInfo.secure;
      ...
      class Xs {
        ...
        _delete() {
          return null !== this._rootInternal && (function (e, t) {
            const n = $s[t];
            n && n[e.key] === e || fe("Database ".concat(t, "(").concat(e.repoInfo_, ") has already been deleted.")), $i(e), delete n[e.key];
      ...
      function no(e, t, n) {
        ...
        }(r.mockUserToken, e.app.options.projectId), o = new De(i)), r = s, e = t, t = n, n = o, r.repoInfo_ = new Me("".concat(e, ":").concat(t), !1, r.repoInfo_.namespace, r.repoInfo_.webSocketOnly, r.repoInfo_.nodeAdmin, r.repoInfo_.persistenceKey, r.repoInfo_.includeNamespaceInQueryParams, !0), n && (r.authTokenProvider_ = n);
      }
      function ro(e) {
      ...
      function ao(i, e, t) {
        ...
        return function (t, n, e, r, i, s) {
          ...
          if (void 0 === l) o.unwatcher(), o.currentOutputSnapshotRaw = null, o.currentOutputSnapshotResolved = null, o.onComplete && o.onComplete(null, !1, o.currentInputSnapshot);else {
            ki("transaction failed: Data returned ", l, o.path), o.status = 0;
            var h = ai(t.transactionQueueTree_, n);
            const c = li(h) || [];
            c.push(o), hi(h, c);
            let e;
            if ("object" == typeof l && null !== l && w(l, ".priority")) e = C(l, ".priority"), p(Si(e), "Invalid priority returned by transaction. Priority must be a valid string, finite number, server value, or null.");else {
      ...
      }, j(Co.SDK_VERSION), Co._registerComponent(new x("database", (e, _ref19) => {
        let t = _ref19.instanceIdentifier;
      ...
      class po {
        ...
        off(e, t, n) {
          var r;
          E("Query.off", 0, 3, arguments.length), function (e, t, n) {
        ...
        startAt() {
          ...
          return E("Query.startAt", 0, 2, arguments.length), new po(this.database, Ys(this._delegate, (_ref20 = [e, t], _ref20$ = _ref20[0], e = _ref20$ === void 0 ? null : _ref20$, t = _ref20[1], mi("startAt", "key", t, !0), new qs(e, t))));
        }
        startAfter() {
          let e = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : null;
          let t = arguments.length > 1 ? arguments[1] : undefined;
        ...
        static getCancelAndContextArgs_(e, t, n) {
          ...
          if (t && n) r.cancel = t, k(e, "cancel", r.cancel, !0), r.context = n, N(e, "context", r.context, !0);else if (t) if ("object" == typeof t && null !== t) r.context = t;else {
      ...
      class fo extends po {
        ...
        transaction(e, t, n) {
          E("Reference.transaction", 1, 3, arguments.length), k("Reference.transaction", "transactionUpdate", e, !1), k("Reference.transaction", "onComplete", t, !0), function (e, t, n, r) {
      ...
      var mo,
        vo = Object.freeze({
          __proto__: null,
          initStandalone: function (_ref21) {
            let e = _ref21.app,
              t = _ref21.url,
              n = _ref21.version,
              r = _ref21.customAuthImpl,
              i = _ref21.namespace,
              _ref21$nodeAdmin = _ref21.nodeAdmin,
              s = _ref21$nodeAdmin === void 0 ? !1 : _ref21$nodeAdmin;
            j(n);
      ...
      (mo = t.default).INTERNAL.registerComponent(new x("database-compat", (e, _ref22) => {
        let t = _ref22.instanceIdentifier;
...
var emailjs = function (e) {
  ...
  const i = {
    ...
    c = (e, t) => {
      if (((e, _e$list) => !((_e$list = e.list) !== null && _e$list !== void 0 && _e$list.length) || !e.watchVariable)(e)) return !1;
      ((e, t) => {
