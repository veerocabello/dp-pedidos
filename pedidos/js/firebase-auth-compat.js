...
!function (e, t) {
  ...
  try {
    !function () {
      ...
      class _ {
        ...
        create(e) {
          var r,
            ...
            s = "".concat(this.serviceName, ": ").concat(s, " (").concat(i, ").");
          return new m(i, s, n);
        }
      }
      const y = /\{\$([^}]+)}/g;
      function I(e) {
        const t = [];
        for (const _ref of Object.entries(e)) {
      ...
      function w(e) {
        const r = {},
          t = e.replace(/^\?/, "").split("&");
        return t.forEach(e => {
          var _e$split, _e$split2;
          var t, n;
          e && (_e$split = e.split("="), _e$split2 = _slicedToArray(_e$split, 2), t = _e$split2[0], n = _e$split2[1], r[decodeURIComponent(t)] = decodeURIComponent(n));
        }), r;
      }
      function T(e) {
        var t = e.indexOf("?");
      ...
      function x(e) {
        ...
        V.logLevel <= c.ERROR && V.error("Auth (".concat(ki.SDK_VERSION, "): ").concat(e), ...t);
      }
      function j(e) {
      ...
      function q(e, t, n) {
        if (!(t instanceof n)) throw n.name !== t.constructor.name && j(e, "argument-error"), W(e, "argument-error", "Type of ".concat(t.constructor.name, " does not match expected instance.") + "Did you pass a reference from a different Auth SDK?");
      }
      function z(e) {
      ...
      function B(e, t) {
        for (var _len1 = arguments.length, n = new Array(_len1 > 2 ? _len1 - 2 : 0), _key1 = 2; _key1 < _len1; _key1++) {
          n[_key1 - 2] = arguments[_key1];
        }
        if (!e) throw z(t, ...n);
      }
      function G(e) {
      ...
      function ae(e, t, n, r) {
        ...
        return e.config.emulator ? Q(e.config, i) : "".concat(e.config.apiScheme, "://").concat(i);
      }
      class oe {
        constructor(e) {
      ...
      async function ve(e) {
        ...
        var s,
          a,
          t = null !== (n = i.providerUserInfo) && void 0 !== n && n.length ? i.providerUserInfo.map(e => {
            var t = e["providerId"],
              n = R(e, ["providerId"]);
            return {
              providerId: t,
      ...
      class ge {
        ...
        updateFromServerResponse(e) {
          ...
          var t,
            n,
            n = "expiresIn" in e && void 0 !== e.expiresIn ? Number(e.expiresIn) : (t = e.idToken, B(n = de(t), "internal-error"), B(void 0 !== n.exp, "internal-error"), B(void 0 !== n.iat, "internal-error"), Number(n.exp) - Number(n.iat));
            ...
            _ref3 = (s = t, await {
              accessToken: (a = await ie(i = e, {}, async () => {
                var e = I({
                  ...
                  _i$config = i.config,
                  t = _i$config.tokenApiHost,
                  n = _i$config.apiKey,
                  n = ae(i, t, "/v1/token", "key=".concat(n));
                const r = await i._getAdditionalHeaders();
      ...
      class ke {
        ...
        static async create(e, t) {
          let n = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : "authUser";
      ...
      function Me(e) {
        ...
        switch (e) {
          case "Browser":
            ...
            break;
          case "Worker":
            n = "".concat(Ee(d()), "-").concat(e);
            break;
          default:
            n = e;
        }
        var r = t.length ? t.join(",") : "FirebaseCore-web";
        return "".concat(n, "/JsCore/").concat(ki.SDK_VERSION, "/").concat(r);
      }
      ...
      class We {
        ...
        async verify() {
          let i = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : "verify";
      ...
      class Be {
        ...
        async _getAppCheckToken() {
          var e,
            t,
            n = await (null === (n = this.appCheckServiceProvider.getImmediate({
              optional: !0
            })) || void 0 === n ? void 0 : n.getToken());
          return null != n && n.error && (e = "Error while retrieving App Check token: ".concat(n.error), t = [], V.logLevel <= c.WARN && V.warn("Auth (".concat(ki.SDK_VERSION, "): ").concat(e), ...t)), null == n ? void 0 : n.token;
        }
      }
      function Ge(e) {
        return E(e);
      ...
      function $e(e, t, n) {
        ...
        var _ref4 = function (e) {
          ...
          o = _ref4.port;
        r.config.emulator = {
          url: "".concat(s, "//").concat(a).concat(null === o ? "" : ":".concat(o), "/")
      ...
      class ct extends Xe {
        ...
        static fromJSON(e) {
          var _e2 = e = "string" == typeof e ? JSON.parse(e) : e,
            t = _e2.verificationId,
            n = _e2.verificationCode,
            r = _e2.phoneNumber,
            i = _e2.temporaryProof;
      ...
      class lt {
        ...
        static parseLink(e) {
          var t,
            n,
            r,
            t = (t = w(T(e = e)).link, n = t ? w(T(t)).deep_link_id : null, ((r = w(T(e)).deep_link_id) ? w(T(r)).link : null) || r || n || t || e);
          try {
            return new lt(t);
          } catch (e) {
            return null;
      ...
      class pt extends ht {
        ...
        static oauthCredentialFromTaggedObject(_ref5) {
          let e = _ref5._tokenResponse;
          if (!e) return null;
          var t = e.oauthIdToken,
            n = e.oauthAccessToken,
            r = e.oauthTokenSecret,
            i = e.pendingToken,
            s = e.nonce,
            a = e.providerId;
      ...
      class ft extends ht {
        ...
        static credentialFromTaggedObject(_ref6) {
          let e = _ref6._tokenResponse;
      ...
      class gt extends ht {
        ...
        static credentialFromTaggedObject(_ref8) {
          let e = _ref8._tokenResponse;
          if (!(e && "oauthAccessToken" in e)) return null;
          if (!e.oauthAccessToken) return null;
          try {
      ...
      class mt extends Xe {
        ...
        static fromJSON(e) {
          var _ref9 = "string" == typeof e ? JSON.parse(e) : e,
            t = _ref9.providerId,
            n = _ref9.signInMethod,
            r = _ref9.pendingToken;
      ...
      class _t extends dt {
        ...
        static samlCredentialFromTaggedObject(_ref0) {
          let e = _ref0._tokenResponse;
          if (!e) return null;
          var t = e.pendingToken,
            n = e.providerId;
          if (!t || !n) return null;
          try {
      ...
      class yt extends ht {
        ...
        static credentialFromTaggedObject(_ref1) {
          let e = _ref1._tokenResponse;
          if (!e) return null;
      ...
      function Et(e) {
        return new Set(e.map(_ref10 => {
          let e = _ref10.providerId;
          return e;
        }).filter(e => !!e));
      }
      async function Rt(e, t) {
      ...
      async function zt(e, _ref11) {
        let t = _ref11.displayName,
          n = _ref11.photoURL;
        if (void 0 !== t || void 0 !== n) {
          ...
          const s = i.providerData.find(_ref12 => {
            let e = _ref12.providerId;
            return "password" === e;
          });
      ...
      class tn {
        ...
        async unenroll(e) {
          ...
          try {
            ...
            this.enrolledFactors = this.enrolledFactors.filter(_ref13 => {
              let e = _ref13.uid;
              return e !== t;
            }), await this.user._updateTokensIfNecessary(s), await this.user.reload();
          } catch (e) {
            throw e;
          }
        }
        ...
        onStorageEvent(e) {
          ...
          if (e.key) {
            ...
            if (t ? this.detachListener() : this.stopPolling(), this.safariLocalStorageNotSynced) {
              ...
              if (e.newValue !== i) null !== e.newValue ? this.storage.setItem(r, e.newValue) : this.storage.removeItem(r);else if (this.localCache[r] === e.newValue && !t) return;
            }
            var n = () => {
      ...
      class hn {
        ...
        async _send(e, t) {
          let a = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : 50;
      ...
      class bn {
        ...
        async _poll() {
          ...
          for (var _ref14 of n) {
            ...
            e = _ref15.fbase_key;
            t = _ref15.value;
            i.add(e), JSON.stringify(this.localCache[e]) !== JSON.stringify(t) && (this.notifyListeners(e, t), r.push(e));
          }
      ...
      class Rn {
        ...
        execute() {
          this.checkIfDeleted(), this.timerId || (this.timerId = window.setTimeout(() => {
            ...
            const _this$params2 = this.params,
              e = _this$params2.callback,
              t = _this$params2["expired-callback"];
            if (e) try {
      ...
      class Cn {
        ...
        load(s) {
          ...
          return B((e = a).length <= 6 && /^\s*[a-zA-Z0-9\-]*\s*$/.test(e), s, "argument-error"), this.shouldResolveImmediately(a) && Fe(pn().grecaptcha) ? Promise.resolve(pn().grecaptcha) : new Promise((t, n) => {
            ...
            }, je("https://www.google.com/recaptcha/api.js??".concat(I({
              onload: An,
              render: "explicit",
              hl: a
            }))).catch(() => {
      ...
      class Ln {
        constructor(e) {
          let t = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : Object.assign({}, On);
        ...
        makeTokenCallback(n) {
          return t => {
            if (this.tokenChangeListeners.forEach(e => e(t)), "function" == typeof n) n(t);else if ("string" == typeof n) {
              const e = pn()[n];
        ...
        async init() {
          B(J() && !fn(), this.auth, "internal-error"), await function () {
            let t = null;
      ...
      class Un {
        ...
        static credentialFromTaggedObject(_ref16) {
          let e = _ref16._tokenResponse;
          if (!e) return null;
          var t = e.phoneNumber,
            n = e.temporaryProof;
      ...
      function dr() {
        const t = pn().___jsl;
        if (null !== t && void 0 !== t && t.H) for (const n of Object.keys(t.H)) if (t.H[n].r = t.H[n].r || [], t.H[n].L = t.H[n].L || [], t.H[n].r = [...t.H[n].L], t.CP) for (let e = 0; e < t.CP.length; e++) t.CP[e] = null;
      }
      let hr = null;
      function pr(e) {
        var i;
        return hr = hr || (i = e, new Promise((e, t) => {
          ...
          if (null !== (r = null === (r = pn().gapi) || void 0 === r ? void 0 : r.iframes) && void 0 !== r && r.Iframe) e(gapi.iframes.getContext());else {
            if (null === (r = pn().gapi) || void 0 === r || !r.load) {
              var r = He("iframefcb");
              return pn()[r] = () => {
                gapi.load ? n() : t(H(i, "network-request-failed"));
              }, je("https://apis.google.com/js/api.js?onload=".concat(r)).catch(e => t(e));
            }
            n();
          }
        }).catch(e => {
      ...
      const fr = new X(5e3, 15e3),
        ...
        _r = new Map([["identitytoolkit.googleapis.com", "p"], ["staging-identitytoolkit.sandbox.googleapis.com", "s"], ["test-identitytoolkit.sandbox.googleapis.com", "t"]]);
      async function yr(a) {
        const e = await pr(a);
        var t = pn().gapi;
        return B(t, a, "internal-error"), e.open({
          ...
          url: function (e) {
            ...
            var n = t.emulator ? Q(t, gr) : "https://".concat(e.config.authDomain, "/").concat(vr);
            const r = {
              apiKey: t.apiKey,
              appName: e.name,
              v: ki.SDK_VERSION
            ...
            return i.length && (r.fw = i.join(",")), "".concat(n, "?").concat(I(r).slice(1));
          }(a),
      ...
      function Tr(e, t, n) {
        var _s;
        let r = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : 500;
        let i = arguments.length > 4 && arguments[4] !== undefined ? arguments[4] : 600;
        ...
        var l,
          a = Object.entries(c).reduce((e, _ref18) => {
            let _ref19 = _slicedToArray(_ref18, 2),
              t = _ref19[0],
              n = _ref19[1];
            return "".concat(e).concat(t, "=").concat(n, ",");
          }, "");
        if (_s = s, n = _s === void 0 ? d() : _s, Le(n) && null !== (l = window.navigator) && void 0 !== l && l.standalone && "_self" !== o) return function (e, t) {
      ...
      async function Rr(e, t, n, r, i, s) {
        ...
        if (t instanceof dt) {
          t.setDefaultLanguage(e.languageCode), a.providerId = t.providerId || "", function (e) {
            for (const t in e) if (Object.prototype.hasOwnProperty.call(e, t)) return;
            return 1;
          }(t.getCustomParameters()) || (a.customParameters = JSON.stringify(t.getCustomParameters()));
          for (var _ref20 of Object.entries(s || {})) {
        ...
        var u = await e._getAppCheckToken(),
          u = u ? "#".concat(Er, "=").concat(encodeURIComponent(u)) : "";
        return "".concat((e = [e["config"]][0], e.emulator ? Q(e, kr) : "https://".concat(e.authDomain, "/").concat(br)), "?").concat(I(l).slice(1)).concat(u);
      }
      ...
      const Sr = class {
        ...
        _initialize(e) {
          ...
          if (this.eventManagers[t]) {
            const _this$eventManagers$t = this.eventManagers[t],
              r = _this$eventManagers$t.manager,
              n = _this$eventManagers$t.promise;
      ...
      Lr = "authIdTokenMaxAge", null === (Dr = o()) || void 0 === Dr || Dr["_".concat(Lr)], Mr = "Browser", ki._registerComponent(new N("auth", (e, _ref22) => {
        let t = _ref22.options;
        var n = e.getProvider("app").getImmediate(),
          r = e.getProvider("heartbeat"),
          i = e.getProvider("app-check-internal");
        const _n$options = n.options,
          s = _n$options.apiKey,
          a = _n$options.authDomain;
      ...
      function Gr(e) {
        ...
        const _e$split5 = e.split("?"),
          _e$split6 = _toArray(_e$split5),
          t = _arrayLikeToArray(_e$split6).slice(1);
        return w(t.join("?"));
      }
      const Kr = class {
        constructor() {
        ...
        attachCallbackListeners(r, i) {
          ...
          const o = t,
            c = "".concat(n.packageName.toLowerCase(), "://");
      ...
      function Qr() {
        var _ref23, _ref23$;
        let e = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : d();
        return v() && 11 === (null === document || void 0 === document ? void 0 : document.documentMode) || (_ref23 = [e], _ref23$ = _ref23[0], e = _ref23$ === void 0 ? d() : _ref23$, /Edge\/\d+/.test(e));
      }
      function Zr() {
        try {
      ...
      function di(e, t) {
        var n,
          r,
          i,
          s = null === (r = t.customData) || void 0 === r ? void 0 : r._tokenResponse;
      ...
      class _i {
          ...
          this._delegate = t.initialize({
            options: {
              persistence: function (e, t) {
                ...
                if ("undefined" != typeof window) for (const r of [on, ln]) n.includes(r) || n.push(r);
        ...
        async getRedirectResult() {
          ...
          var e,
            t,
            n = (e = this._delegate, t = li, await Ge(e)._initializationPromise, await tr(e, t, !1));
      ...
      function yi(e, t, n) {
        var _e3;
        let r = e;
        "function" != typeof e && (_e3 = e, r = _e3.next, t = _e3.error, n = _e3.complete, _e3);
        const i = r;
        return {
      ...
      class Ti {
        constructor(e, t) {
          let n = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : i.default.app();
          var r;
