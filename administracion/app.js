...
function bimbaPintarMkCalendarioLista() {
  ...
  el.innerHTML = combinado.map(function (item) {
    ...
    return '<div style="background:#fff;border:1.5px solid #F5E6C8;border-radius:10px;padding:10px 12px;margin-bottom:6px">'
      ...
      + (p.texto ? '<div style="font-size:12px;color:#3D1F0D;margin-bottom:6px;white-space:pre-line;overflow-wrap:break-word">' + escapeHtml(p.texto) + '</div>' : '')
...
function bimbaMkIdeaCardHtml(i) {
  ...
  return '<div style="background:#fff;border:1.5px solid #F5E6C8;border-radius:12px;padding:14px;margin-bottom:10px">'
    ...
    + '<div style="flex:1;min-width:0;font-size:14px;font-weight:500;color:#3D1F0D;line-height:1.45;white-space:pre-line;overflow-wrap:break-word">' + _mkFormatearTexto(i.idea) + '</div>'
    + '</div>'
...
function bimbaPintarMkColabsLista() {
  ...
  el.innerHTML = _mkColabsCache.map(function (c) {
    ...
    return '<div style="background:#fff;border:1.5px solid #F5E6C8;border-radius:10px;padding:10px 12px;margin-bottom:6px">'
      ...
      + (c.notas ? '<div style="font-size:12px;color:#3D1F0D;margin-bottom:6px;white-space:pre-line;overflow-wrap:break-word">' + escapeHtml(c.notas) + '</div>' : '')
